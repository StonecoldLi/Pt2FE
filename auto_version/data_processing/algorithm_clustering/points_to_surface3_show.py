...
def visualize_clusters_with_open3d(points, labels):
    # 创建一个点云对象
    ...
    # 使用Open3D绘制点云
    o3d.visualization.draw_geometries([pcd], window_name="Clustered Point Cloud", width=800, height=800)


# 点云和平面模型的可视化
points_sample = np.loadtxt('../../data/rotated_data/jie5_rot_txt.txt',skiprows=1)
n_planes=3
...
visualize_clusters_with_open3d(np.loadtxt('../../data/rotated_data/jie5_rot_txt.txt',skiprows=1),refined_assignments)
